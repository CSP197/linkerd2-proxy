...
pub struct Config {
    ...
    pub controller_name: tls::PeerIdentity,
    //
    // Destination Config
    //
...
pub const ENV_IDENTITY_CONTROLLER_NAME: &str = "LINKERD2_PROXY_IDENTITY_CONTROLLER_NAME";
...
impl Config {
    ...
    pub fn parse<S: Strings>(strings: &S) -> Result<Self, Error> {
        ...
        let controller_name = parse(strings, ENV_IDENTITY_CONTROLLER_NAME, parse_identity);
